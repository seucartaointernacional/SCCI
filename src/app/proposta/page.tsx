    ...
    <main className="min-h-screen bg-gradient-to-b from-blue-50 to-white flex items-center justify-center px-4 py-8">
      <AnimatePresence mode="wait">
        {view === "loading" && (
          <motion.div
            key="loading"
            className="card-container w-full flex flex-col items-center justify-center py-16"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
        ...
        {view === "proposal" && proposalData && (
          ...
          >
            ...
            <div className="text-center mb-6">
              ...
              >
                Conseguimos uma proposta para voc&ecirc;!
              </motion.h1>
              <motion.p
              ...
              >
                Confira os detalhes do seu cart&atilde;o internacional
              </motion.p>
            </div>
        ...
        {view === "recusa" && (
          <motion.div
            key="recusa"
            className="card-container w-full text-center"
            initial={{ opacity: 0, y: 30 }}
            animate={{ opacity: 1, y: 0 }}
            exit={{ opacity: 0, y: -20 }}
            transition={{ duration: 0.5, ease: "easeOut" }}
          >
            ...
            <motion.p
              ...
              transition={{ delay: 0.4 }}
            >
              N&atilde;o temos mais propostas para voc&ecirc; neste momento.
            </motion.p>
            ...
            >
              ...
              >
                Voltar &agrave; Proposta Anterior
              </button>
              <button
                onClick={() => router.push("/")}
